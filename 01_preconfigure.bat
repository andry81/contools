...
for /F "usebackq eol= tokens=* delims=" %%i in (`@"%CONTOOLS_UTILITIES_BIN_ROOT%/contools/wxFileDialog.exe" "" "%CONTOOLS_PROJECT_ROOT%" "Select the third party catalog to link with..." -de`) do set "CONTOOLS_3DPARTY_ROOT=%%i"
