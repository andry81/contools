...
for /F "usebackq eol= tokens=1,2 delims==" %%i in (`"%%SystemRoot%%\System32\wbem\wmic.exe" path Win32_OperatingSystem get LocalDateTime /VALUE 2^>nul`) do if "%%i" == "LocalDateTime" set "RETURN_VALUE=%%j"
