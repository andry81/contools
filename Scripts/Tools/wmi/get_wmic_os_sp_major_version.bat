...
for /F "usebackq tokens=1,2 delims=="eol^= %%i in (`@"%%SystemRoot%%\System32\wbem\wmic.exe" path Win32_OperatingSystem get ServicePackMajorVersion /VALUE 2^>nul`) do if "%%i" == "ServicePackMajorVersion" set "RETURN_VALUE=%%j"
