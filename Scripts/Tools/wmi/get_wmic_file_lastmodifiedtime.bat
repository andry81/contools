...
for /F "usebackq tokens=1,* delims=="eol^= %%i in (`@"%%SystemRoot%%\System32\wbem\wmic.exe" DataFile where "Name='%%FILE:\=\\%%'" get LastModified /VALUE`) do ^
if "%%i" == "LastModified" set "RETURN_VALUE=%%j"
