...
set "__STRING__=!__STRING__:$3F=?!" & set "__STRING__=!__STRING__:$20= !" & set "__STRING__=!__STRING__:$2C=,!"  & set "__STRING__=!__STRING__:$3B=;!" & ^
set "__STRING__=!__STRING__:$2A=*!" & set "__STRING__=!__STRING__:$3D==!" & ^
