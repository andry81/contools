...
rem default values
if "%TASK_NAME%" == "" set TASK_NAME=.
if "%TEMP_PARENT_PATH%" == "" set TEMP_PARENT_PATH=.

set "TEMP_PARENT_PATH_DIR="
if not "%TEMP_PARENT_PATH%" == "" set "TEMP_PARENT_PATH_DIR=%TEMP_PARENT_PATH%\"

if "%SCRIPT_TEMP_NEST_LVL%" == "" set SCRIPT_TEMP_NEST_LVL=0

if %SCRIPT_TEMP_NEST_LVL% NEQ 0 if not "%SCRIPT_TEMP_CURRENT_DIR%" == "" if exist "%SCRIPT_TEMP_CURRENT_DIR%\" goto ALLOC_NESTED_TEMP
...
set "SCRIPT_TEMP_ROOT_DIR=%TEMP%\%TEMP_PARENT_PATH_DIR%%TEMP_DIR_NAME_PREFIX%.%SCRIPT_TEMP_ROOT_DATE%.%SCRIPT_TEMP_ROOT_TIME%"
