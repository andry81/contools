...
rem   check before call. Does not support long paths.
rem
rem   Not strict version, does not report an error in case of disconnected
rem   symbolic reference to a directory.
