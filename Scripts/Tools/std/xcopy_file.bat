...
echo.^>^>robocopy.exe "%FROM_PATH_ABS%" "%TO_PATH_ABS%" "%FROM_FILE%" /R:0 /W:0 /NP /TEE /NJH /NS /NC /XX %ROBOCOPY_FLAGS%%ROBOCOPY_EXCLUDES_CMD%
robocopy.exe "%FROM_PATH_ABS%" "%TO_PATH_ABS%" "%FROM_FILE%" /R:0 /W:0 /NP /TEE /NJH /NS /NC /XX %ROBOCOPY_FLAGS%%ROBOCOPY_EXCLUDES_CMD%
