...
set "TORTOISEPROC_PATHFILE_ANSI_CRLF_TMP=%TEMP_FILE_OUTTER_DIR%\%TORTOISEPROC_PATHFILE_NAME_ANSI_CRLF_TMP%"
set "TORTOISEPROC_PATHFILE_FILTERED_ANSI_CRLF_TMP=%TEMP_FILE_OUTTER_DIR%\%TORTOISEPROC_PATHFILE_FILTERED_NAME_ANSI_CRLF_TMP%"
