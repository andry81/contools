...
if not defined CERTUTIL_ADAPTOR_PROJECT_OUTPUT_CONFIG_ROOT  call :CANONICAL_PATH CERTUTIL_ADAPTOR_PROJECT_OUTPUT_CONFIG_ROOT  "%%PROJECT_OUTPUT_ROOT%%/config/contools/tool_adaptors/certutil"
