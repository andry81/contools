...
if not defined QBITTORRENT_ADAPTOR_PROJECT_ROOT               call :CANONICAL_PATH QBITTORRENT_ADAPTOR_PROJECT_ROOT               "%%~dp0.."

if not defined QBITTORRENT_ADAPTOR_PROJECT_INPUT_CONFIG_ROOT  call :CANONICAL_PATH QBITTORRENT_ADAPTOR_PROJECT_INPUT_CONFIG_ROOT  "%%QBITTORRENT_ADAPTOR_PROJECT_ROOT%%/_config"
if not defined QBITTORRENT_ADAPTOR_PROJECT_OUTPUT_CONFIG_ROOT call :CANONICAL_PATH QBITTORRENT_ADAPTOR_PROJECT_OUTPUT_CONFIG_ROOT "%%PROJECT_OUTPUT_ROOT%%/config/contools/tool_adaptors/qbittorrent"
...
call :CANONICAL_PATH ROAMINGAPPDATA                       "%%ROAMINGAPPDATA%%"

call :CANONICAL_PATH QBITTORRENT_LOCAL_CONFIG_DIR         "%%QBITTORRENT_LOCAL_CONFIG_DIR%%"
call :CANONICAL_PATH QBITTORRENT_ROAMING_CONFIG_DIR       "%%QBITTORRENT_ROAMING_CONFIG_DIR%%"

call :CANONICAL_PATH QBITTORRENT_ADAPTOR_BACKUP_DIR       "%%QBITTORRENT_ADAPTOR_BACKUP_DIR%%"
