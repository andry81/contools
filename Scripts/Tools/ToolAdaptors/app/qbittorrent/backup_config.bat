...
call :XCOPY_FILE "%%QBITTORRENT_ROAMING_CONFIG_DIR%%"           qBittorrent.ini         "%%QBITTORRENT_ADAPTOR_BACKUP_DIR%%/%%QBITTORRENT_ADAPTOR_BACKUP_FILE_NAME_PREFIX%%%%PROJECT_LOG_FILE_NAME_SUFFIX%%" /Y /D /H || exit /b 10
call :XCOPY_FILE "%%QBITTORRENT_ROAMING_CONFIG_DIR%%"           qBittorrent-data.ini    "%%QBITTORRENT_ADAPTOR_BACKUP_DIR%%/%%QBITTORRENT_ADAPTOR_BACKUP_FILE_NAME_PREFIX%%%%PROJECT_LOG_FILE_NAME_SUFFIX%%" /Y /D /H || exit /b 10
