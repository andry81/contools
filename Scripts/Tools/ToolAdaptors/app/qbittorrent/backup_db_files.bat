...
call "%%CONTOOLS_ROOT%%/build/xcopy_dir.bat"  "%%QBITTORRENT_LOCAL_CONFIG_DIR%%/BT_backup"                           "%%QBITTORRENT_ADAPTOR_BACKUP_DIR%%/%%QBITTORRENT_ADAPTOR_BACKUP_FILE_NAME_PREFIX%%%%PROJECT_LOG_FILE_NAME_DATE_TIME%%/BT_backup" /Y /D /H || exit /b 10
call "%%CONTOOLS_ROOT%%/build/xcopy_dir.bat"  "%%QBITTORRENT_LOCAL_CONFIG_DIR%%/GeoDB"                               "%%QBITTORRENT_ADAPTOR_BACKUP_DIR%%/%%QBITTORRENT_ADAPTOR_BACKUP_FILE_NAME_PREFIX%%%%PROJECT_LOG_FILE_NAME_DATE_TIME%%/GeoDB" /Y /D /H || exit /b 10
