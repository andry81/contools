...
set "GH_REPOS_BACKUP_DIR=%GH_ADAPTOR_BACKUP_DIR%/restapi/repos/user/%OWNER%"
...
:PAGE_LOOP
call set "GH_AUTH_USER_REPOS_URL_PATH=%%GH_AUTH_USER_REPOS_URL:{{OWNER}}=%OWNER%%%"

set "GH_AUTH_USER_REPOS_URL_PATH=%GH_AUTH_USER_REPOS_URL_PATH%?type=%TYPE%&per_page=%GH_RESTAPI_PARAM_PER_PAGE%&page=%PAGE%"

set "CURL_OUTPUT_FILE=%GH_REPOS_BACKUP_TEMP_DIR%/%GH_AUTH_USER_REPOS_FILE%"

call set "CURL_OUTPUT_FILE=%%CURL_OUTPUT_FILE:{{TYPE}}=%TYPE%%%"
call set "CURL_OUTPUT_FILE=%%CURL_OUTPUT_FILE:{{PAGE}}=%PAGE%%%"

call :CURL "%%GH_AUTH_USER_REPOS_URL_PATH%%" || goto MAIN_EXIT
echo.
