...
if not defined WKHTMLTOPDF_ADAPTOR_PROJECT_OUTPUT_CONFIG_ROOT  call :CANONICAL_PATH WKHTMLTOPDF_ADAPTOR_PROJECT_OUTPUT_CONFIG_ROOT  "%%PROJECT_OUTPUT_ROOT%%/config/tool_adaptors/wkhtmltopdf"
