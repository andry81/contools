...
if not defined EMULE_ADAPTOR_PROJECT_OUTPUT_CONFIG_ROOT call :CANONICAL_PATH EMULE_ADAPTOR_PROJECT_OUTPUT_CONFIG_ROOT "%%PROJECT_OUTPUT_ROOT%%/config/emule_adaptor"
