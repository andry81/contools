...
call "%%CONTOOLS_ROOT%%/build/xcopy_file.bat" "%%EMULE_TEMP_DIR%%"             *.part.met                    "%%EMULE_ADAPTOR_BACKUP_DIR%%/%%EMULE_ADAPTOR_BACKUP_FILE_NAME_PREFIX%%%%PROJECT_LOG_FILE_NAME_DATE_TIME%%" /Y /D /H || exit /b 10
call "%%CONTOOLS_ROOT%%/build/xcopy_file.bat" "%%EMULE_TEMP_DIR%%"             *.part.met.bak                "%%EMULE_ADAPTOR_BACKUP_DIR%%/%%EMULE_ADAPTOR_BACKUP_FILE_NAME_PREFIX%%%%PROJECT_LOG_FILE_NAME_DATE_TIME%%" /Y /D /H || exit /b 11
...
call "%%CONTOOLS_ROOT%%/build/call.bat" rmdir /S /Q "%%EMULE_ADAPTOR_BACKUP_DIR%%/%%EMULE_ADAPTOR_BACKUP_FILE_NAME_PREFIX%%%%PROJECT_LOG_FILE_NAME_DATE_TIME%%"
