...
if not defined FLYLINK_ADAPTOR_PROJECT_OUTPUT_CONFIG_ROOT call :CANONICAL_PATH FLYLINK_ADAPTOR_PROJECT_OUTPUT_CONFIG_ROOT "%%PROJECT_OUTPUT_ROOT%%/config/flylink_adaptor"
