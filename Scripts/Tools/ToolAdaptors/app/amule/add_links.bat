...
set AMULE_CMDLINE=/P "%ECPASS%" /c "add %AMULE_LINK_STR%%LINK_SUFFIX%"

echo.%NUM_LINK_STR% of %NUM_OVERALL_LINK_STR%: ^>"%AMULE_EXECUTABLE%" %AMULE_CMDLINE%
"%AMULE_EXECUTABLE%" %AMULE_CMDLINE%
