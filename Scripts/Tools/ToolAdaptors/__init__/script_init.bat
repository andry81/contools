...
call "%%CONTOOLS_ROOT%%/std/callshift.bat" -skip %%EXEC_CALLF_FLAG_SHIFT%% 1 "%%CONTOOLS_ROOT%%/exec/exec_callf_prefix.bat"%%EXEC_CALLF_PREFIX_BARE_FLAGS%% -- %%* || exit /b
