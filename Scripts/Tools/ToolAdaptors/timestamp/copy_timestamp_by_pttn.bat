...
for /F "usebackq eol=| tokens=* delims=" %%i in (`dir /A:-D /B /O:N "%INPUT_PATH_PTTN%" 2^> nul`) do (
...
"%CONTOOLS_UTILITIES_BIN_ROOT%/stevemiller/touch.exe" /c /m /a /r "%INPUT_FILE_PATH%" "%OUTPUT_FILE_PATH%"
