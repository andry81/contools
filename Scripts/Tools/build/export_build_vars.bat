...
call :WRITE_VAR_FILE PROJECT_STAGE_BUILD_ROOT.LIB_DIR     "%%EXPORT_VARS_FILE%%" || goto :EOF
call :WRITE_VAR_FILE PROJECT_STAGE_BUILD_ROOT.GEN_DIR     "%%EXPORT_VARS_FILE%%" || goto :EOF
call :WRITE_VAR_FILE PROJECT_STAGE_BUILD_ROOT.VAR_DIR     "%%EXPORT_VARS_FILE%%" || goto :EOF
call :WRITE_VAR_FILE PROJECT_STAGE_POSTBUILD_ROOT.BIN_DIR "%%EXPORT_VARS_FILE%%" || goto :EOF
call :WRITE_VAR_FILE PROJECT_STAGE_POSTBUILD_ROOT.PDB_DIR "%%EXPORT_VARS_FILE%%" || goto :EOF
call :WRITE_VAR_FILE PROJECT_STAGE_POSTBUILD_ROOT.LIB_DIR "%%EXPORT_VARS_FILE%%" || goto :EOF
