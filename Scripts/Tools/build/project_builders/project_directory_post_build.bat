...
) else call "%%~dp0project_directory_pre_validate_vars.bat" %%3 %%4 %%5 %%6 %%7 %%8 %%9 || exit /b 12
...
call "%%CONTOOLS_BUILD_TOOLS_ROOT%%/mkdir_if_notexist.bat" "%%PROJECT_STAGE_POSTBUILD_ROOT.VAR_DIR%%" || exit /b
