...
if exist "%PROJECT_STAGE_POSTBUILD_ROOT.GEN_DIR%" (
  call "%%CONTOOLS_ROOT%%/std/mkdir.bat" "%%%PROJECT_NAMESPACE%.PROJECT_STAGE_BUILD_ROOT.GEN_DIR%%/%%PROJECT_NAME%%"
  call "%%CONTOOLS_ROOT%%/std/xcopy_dir.bat" "%%PROJECT_STAGE_POSTBUILD_ROOT.GEN_DIR%%" "%%%PROJECT_NAMESPACE%.PROJECT_STAGE_BUILD_ROOT.GEN_DIR%%/%%PROJECT_NAME%%" /E /Y /D || goto :EOF
)
rem pdb
if exist "%PROJECT_STAGE_POSTBUILD_ROOT.PDB_DIR%" (
  call "%%CONTOOLS_ROOT%%/std/mkdir.bat" "%%%PROJECT_NAMESPACE%.PROJECT_STAGE_BUILD_ROOT.PDB_DIR%%/%%PROJECT_NAME%%"
  call "%%CONTOOLS_ROOT%%/std/xcopy_dir.bat" "%%PROJECT_STAGE_POSTBUILD_ROOT.PDB_DIR%%" "%%%PROJECT_NAMESPACE%.PROJECT_STAGE_BUILD_ROOT.PDB_DIR%%/%%PROJECT_NAME%%" /E /Y /D || goto :EOF
)
rem lib
if exist "%PROJECT_STAGE_POSTBUILD_ROOT.LIB_DIR%" (
  call "%%CONTOOLS_ROOT%%/std/mkdir.bat" "%%%PROJECT_NAMESPACE%.PROJECT_STAGE_BUILD_ROOT.LIB_DIR%%/%%PROJECT_NAME%%"
  call "%%CONTOOLS_ROOT%%/std/xcopy_dir.bat" "%%PROJECT_STAGE_POSTBUILD_ROOT.LIB_DIR%%" "%%%PROJECT_NAMESPACE%.PROJECT_STAGE_BUILD_ROOT.LIB_DIR%%/%%PROJECT_NAME%%" /E /Y /D || goto :EOF
)
rem var
if exist "%PROJECT_STAGE_POSTBUILD_ROOT.VAR_DIR%" (
  call "%%CONTOOLS_ROOT%%/std/mkdir.bat" "%%%PROJECT_NAMESPACE%.PROJECT_STAGE_BUILD_ROOT.VAR_DIR%%/%%PROJECT_NAME%%"
  call "%%CONTOOLS_ROOT%%/std/xcopy_dir.bat" "%%PROJECT_STAGE_POSTBUILD_ROOT.VAR_DIR%%" "%%%PROJECT_NAMESPACE%.PROJECT_STAGE_BUILD_ROOT.VAR_DIR%%/%%PROJECT_NAME%%" /E /Y /D || goto :EOF
)
