...
if not exist "%STAGE_BIN_EXCLUDES_FILE%" set "STAGE_BIN_EXCLUDES_FILE="

call "%%BUILD_TOOLS_ROOT%%/xcopy_archive_to_stageout_all_dirs.bat" "stage" "../.." ^
  "%%PROJECT_STAGE_BUILD_ROOT.BIN_DIR%%" "%%PROJECT_STAGE_POSTBUILD_ROOT.BIN_DIR%%" "%%STAGE_BIN_EXCLUDES_FILE%%" ^
