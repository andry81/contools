...
if defined ARCHIVE_EXCLUDE_FILES_LIST ( call :PROCESS_EXCLUDES_LIST "%%ARCHIVE_EXCLUDE_FILES_LIST%%" || goto :EOF )
if defined ARCHIVE_EXCLUDE_DIRS_LIST ( call :PROCESS_EXCLUDES_LIST "%%ARCHIVE_EXCLUDE_DIRS_LIST%%" || goto :EOF )
