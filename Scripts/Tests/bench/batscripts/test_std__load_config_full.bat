...
setlocal
call "%%CONTOOLS_ROOT%%/std/load_config.bat" -full_parse "%%TEST_DATA_BASE_DIR%%/test_std__load_config" "%%TEST_DATA_BASE_DIR%%/test_std__load_config" config.system.vars || (
