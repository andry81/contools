...
"%CONTOOLS_UTILITIES_BIN_ROOT%/contools/printf.exe" "=${VARVALUE_ACTUAL}=${VARVALUE_REFERENCE}="

"%CONTOOLS_UTILITIES_BIN_ROOT%/contools/envvarcmp.exe" VARVALUE_ACTUAL VARVALUE_REFERENCE "" ^
