...
endlocal&& (
  ...
  call :RESET_ENV_AND_CALL vars_win2k.lst "%%TOOLS_PATH_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%"
)
goto :EOF
...
endlocal&& (
  ...
  call :RESET_ENV_AND_CALL vars_winxp.lst "%%TOOLS_PATH_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%"
)
goto :EOF
...
endlocal&& (
  ...
  call :RESET_ENV_AND_CALL vars_vista.lst "%%TOOLS_PATH_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%"
)
goto :EOF
...
endlocal&& (
  ...
  call :RESET_ENV_AND_CALL vars_win7.lst "%%TOOLS_PATH_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%"
)
goto :EOF
...
endlocal&& (
  ...
  call :RESET_ENV_AND_CALL vars_win8.lst "%%TOOLS_PATH_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%"
)
goto :EOF
