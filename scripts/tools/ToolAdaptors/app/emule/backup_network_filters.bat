...
:MAIN
set "EMULE_ADAPTOR_BACKUP_FILE_NAME_PREFIX=emule--network-filters-"

call "%%CONTOOLS_BUILD_TOOLS_ROOT%%/xcopy_file.bat" "%%EMULE_CONFIG_DIR%%"          ipfilter.dat                  "%%EMULE_ADAPTOR_BACKUP_DIR%%/%%EMULE_ADAPTOR_BACKUP_FILE_NAME_PREFIX%%%%PROJECT_LOG_FILE_NAME_DATE_TIME%%" /Y /D /H || exit /b 10
