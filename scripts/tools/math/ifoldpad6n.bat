...
set "L=" & set "F=0" & ( if "!L1!!L2!!L3!!L4!!L5!!L6!" == "000000" set "F=1" ) & ( if defined R call "%%~dp0ufoldpad6n.bat" L R && set "F=0" || set "L=" ) ^
...
rem USAGE:
rem   ifoldpad6n.bat <out-var> <var>

rem Description:
rem   Signed integer series fold script with 0 padding from the left.
rem
