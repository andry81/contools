...
set "L1=%%i" & set "L2=%%j" & set "L3=%%k" & set "L4=%%l" & set "L5=%%m" & set "L6=%%n" & set "F=%%o" & set "S=" & set "DS=" ^
  ...
  & ( if defined F call "%%~dp0inorm.bat" F F || call set /A "L6+=%%ERRORLEVEL%%" ) ^
  & ( if "!D:~0,1!" == "-" set "D=!D:~1!" & set "DS=-" ) & set /A "L6=!S!L6" & ^
...
set /A "L2+=L3 / 1000" & set /A "L3%%=1000" & set /A "L1+=L2 / 1000" & set /A "L2%%=1000" & set /A "R=L1 %% D" & set /A "L1/=D" ^
  ...
  & ( if !R! NEQ 0 ( ( if "!L3:~2,1!" == "" set "L3=0!L3!" ) & ( if "!L3:~2,1!" == "" set "L3=0!L3!" ) & set "R=!R!!L3!" ) else set "R=!L3!" ) & set /A "L3=R / D" & set /A "R%%=D" ^
  & ( if !R! NEQ 0 ( ( if "!L4:~2,1!" == "" set "L4=0!L4!" ) & ( if "!L4:~2,1!" == "" set "L4=0!L4!" ) & set "R=!R!!L4!" ) else set "R=!L4!" ) & set /A "L4=R / D" & set /A "R%%=D" ^
...
rem USAGE:
rem   idiv.bat <out-var> <lvar> <rvalue>
