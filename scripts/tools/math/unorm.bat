...
set /A "L5=L5 + L6 / 1000" & set /A "L6%%=1000" & set /A "L4=L4 + L5 / 1000" & set /A "L5%%=1000" & set /A "L3=L3 + L4 / 1000" & set /A "L4%%=1000" & ^
set /A "L2=L2 + L3 / 1000" & set /A "L3%%=1000" & set /A "L1+=L2 / 1000" & set /A "L2%%=1000" & set /A "R=L1 / 1000" & set /A "L1%%=1000" ^
