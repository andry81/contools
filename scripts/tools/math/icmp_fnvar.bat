...
set "L=!%~1!" & set "R=!%~3!" & ( if not defined L set "L=0" ) & ( if not defined R set "R=0" ) & set "LS=+" & set "RS=+" ^
  & ( if "!L:~0,1!" == "+" set "L=!L:~1!" ) & ( if "!R:~0,1!" == "+" set "R=!R:~1!" ) ^
  & ( if "!L:~0,1!" == "-" set "LS=-" & set "L=!L:~1!" ) & ( if "!R:~0,1!" == "-" set "RS=-" & set "R=!R:~1!" ) & ^
...
set "L1=%%a" & set "L2=%%b" & set "L3=%%c" & set "L4=%%d" & set "L5=%%e" & set "L6=%%f" & set "LR=%%g" ^
  ...
  & ( if not defined L6 set "L6=0" ) & ( if "!L6:~2,1!" == "" set "L6=0!L6!" ) & ( if "!L6:~2,1!" == "" set "L6=0!L6!" ) & set "L=!LS!!L1!,!L2!,!L3!,!L4!,!L5!,!L6!" & ^
...
set "L1=%%a" & set "L2=%%b" & set "L3=%%c" & set "L4=%%d" & set "L5=%%e" & set "L6=%%f" & set "RR=%%g" ^
  ...
  & ( if not defined L4 set "L4=0" ) & ( if "!L4:~2,1!" == "" set "L4=0!L4!" ) & ( if "!L4:~2,1!" == "" set "L4=0!L4!" ) ^
  & ( if not defined L5 set "L5=0" ) & ( if "!L5:~2,1!" == "" set "L5=0!L5!" ) & ( if "!L5:~2,1!" == "" set "L5=0!L5!" ) ^
  & ( if not defined L6 set "L6=0" ) & ( if "!L6:~2,1!" == "" set "L6=0!L6!" ) & ( if "!L6:~2,1!" == "" set "L6=0!L6!" ) & set "R=!RS!!L1!,!L2!,!L3!,!L4!,!L5!,!L6!" ^
...
rem USAGE:
rem   icmp_fnvar.bat <lvar> <op> <rvar>

rem Description:
rem   Compares folded signed integer number values in variables as 0
