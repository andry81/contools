...
set "OP=%~2" & setlocal ENABLEDELAYEDEXPANSION ^
  ...
  & ( if /i "!OP!" == "LSS" endlocal & ( if "%%i" LSS "%%j" ( exit /b 0 ) else if "%%i" EQU "%%j" ( call "%%~0" LR LSS RR & exit /b ) else exit /b 1 ) ) ^
  & ( if /i "!OP!" == "GEQ" endlocal & ( if "%%i" GTR "%%j" ( exit /b 0 ) else if "%%i" EQU "%%j" ( call "%%~0" LR GEQ RR & exit /b ) else exit /b 1 ) ) ^
  & ( if /i "!OP!" == "GTR" endlocal & ( if "%%i" GTR "%%j" ( exit /b 0 ) else if "%%i" EQU "%%j" ( call "%%~0" LR GTR RR & exit /b ) else exit /b 1 ) ) ^
  & ( if /i "!OP!" == "LEQ" endlocal & ( if "%%i" LSS "%%j" ( exit /b 0 ) else if "%%i" EQU "%%j" ( call "%%~0" LR LEQ RR & exit /b ) else exit /b 1 ) )
exit /b -1
