...
set "L1=%%a" & set "L2=%%b" & set "L3=%%c" & set "L4=%%d" & set "L5=%%e" & set "L6=%%f" & set "F=%%g" & set "S=" ^
...
set /A "L2=!S!L2 + L3 / 1000" & set /A "L3%%=1000" & set /A "L1+=L2 / 1000" & set /A "L2%%=1000" & set /A "R=L1 / 1000" & set /A "L1%%=1000" ^
  & ( if defined F set "F=,!F:-=!" ) & ( if "!L1!!L2!!L3!!L4!!L5!!L6!" == "000000" set "S=" ) & ^
