...
if %WINDOWS_MAJOR_VER% GEQ 6 (
  if defined TESTLIB__OUTER_CP if not "%TESTLIB__OUTER_CP%" == "65001" "%TESTLIB__CHCP_EXE%" %TESTLIB__OUTER_CP% >nul
) else if defined TESTLIB__OUTER_CP if not "%TESTLIB__OUTER_CP%" == "437" "%TESTLIB__CHCP_EXE%" %TESTLIB__OUTER_CP% >nul
