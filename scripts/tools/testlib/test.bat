...
:TEST_EXIT
if %TEST_IMPL_SKIP% NEQ 0 set TEST_IMPL_ERROR=-1
...
if %TEST_IMPL_SKIP% NEQ 0 (
  set /A "TESTLIB__CURRENT_SKIPPED_TESTS+=1" & set /A "TESTLIB__OVERALL_SKIPPED_TESTS+=1" & set "TESTLIB__TEST_STATUS_MSG=SKIPPED"
) else if %TEST_LAST_ERROR% EQU 0 (
  set /A "TESTLIB__CURRENT_PASSED_TESTS+=1" & set /A "TESTLIB__OVERALL_PASSED_TESTS+=1" & set "TESTLIB__TEST_STATUS_MSG=PASSED"
) else set "TESTLIB__TEST_STATUS_MSG=FAILED"
