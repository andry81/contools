...
for /F "usebackq tokens=1,2 delims=="eol^= %%i in (`@"%%SystemRoot%%\System32\wbem\wmic.exe" path Win32_OperatingSystem get Version /VALUE 2^>nul`) do ^
if "%%i" == "Version" set "RETURN_VALUE=%%j"
