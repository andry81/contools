...
for /F "usebackq tokens=1,* delims=="eol^= %%i in (`@"%%SystemRoot%%\System32\wbem\wmic.exe" path Win32_OperatingSystem get LastBootUpTime /VALUE 2^>nul`) do ^
if "%%i" == "LastBootUpTime" set "RETURN_VALUE=%%j"
...
rem Description:
rem   Independent to Windows locale last boot time request.
