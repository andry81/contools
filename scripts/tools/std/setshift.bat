...
rem   * Does restore previous ERRORLEVEL variable after a variable assign or on
rem     an error before the assign.
...
rem script flags
set /A "FLAG_SHIFT=0", "FLAG_EXE=0", "FLAG_NO_TRIM=0", "FLAG_SKIP=0", "FLAG_NUM_ARGS=65536"
