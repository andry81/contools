...
for %%a in ("" "-") do (
  ...
  set OUTREF=%%~a1,234,567,891,234,567,891
  call :TEST OUT IN
  endlocal

  setlocal
  set IN=%%~a12345678912345678912
  set OUTREF=%%~a12,345,678,912,345,678,912
  call :TEST OUT IN
  endlocal

  setlocal
  set IN=%%~a123456789123456789123
  set OUTREF=%%~a123,456,789,123,456,789,123
  call :TEST OUT IN
  endlocal

  setlocal
  set IN=%%~a1234567891234567891234
  set OUTREF=%%~a1,234,567,891,234,567,891,234
  call :TEST OUT IN
  endlocal

  setlocal
  set IN=%%~a12345678912345678912345
  set OUTREF=%%~a12,345,678,912,345,678,912,345
  call :TEST OUT IN
  endlocal

  setlocal
  set IN=%%~a123456789123456789123456
  set OUTREF=%%~a123,456,789,123,456,789,123,456
  call :TEST OUT IN
  endlocal

  setlocal
  set IN=%%~a1234567891234567891234567
  set OUTREF=%%~a1,234,567,891,234,567,891,234,567
  call :TEST OUT IN
  endlocal

  setlocal
  set IN=%%~a12345678912345678912345678
  set OUTREF=%%~a12,345,678,912,345,678,912,345,678
  call :TEST OUT IN
  endlocal

  setlocal
  set IN=%%~a123456789123456789123456789
  set OUTREF=%%~a123,456,789,123,456,789,123,456,789
  call :TEST OUT IN
  endlocal

  setlocal
  set IN=%%~a1234567891234567891234567891
  set OUTREF=%%~a1,234,567,891,234,567,891,234,567,891
  call :TEST OUT IN
  endlocal
)
...
for %%a in ("" "-") do (
  ...
  set OUTREF=%%~a1,0,0,0,0,0,0
  call :TEST OUT IN
  endlocal

  setlocal
  set IN=%%~a1100000000000000000
  set OUTREF=%%~a1,100,0,0,0,0,0
  call :TEST OUT IN
  endlocal
