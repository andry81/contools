...
call "%%CONTOOLS_ROOT%%/std/canonical_path.bat" TESTS_LIST_FILE     "%%TESTS_PROJECT_ROOT%%/test_encoding/.tests/02_CRLF/01_unix2dos.lst"
...
for /f "usebackq eol=# tokens=* delims=" %%i in ("%TESTS_LIST_FILE%") do call :TEST "02_CRLF\%%i" -i
