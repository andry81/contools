...
call "%%CONTOOLS_ROOT%%/std/canonical_path.bat" TESTS_LIST_FILE     "%%TESTS_PROJECT_ROOT%%/test_encoding/.tests/03_LF/02_dos2unix.lst"
...
for /f "usebackq eol=# tokens=* delims=" %%i in ("%TESTS_LIST_FILE%") do call :TEST "03_LF\%%i" -i -fix-tail-lr
